...
class ForgotPassViewC: UIViewController {
        ...
        override func viewDidLoad() {
            super.viewDidLoad()
            submit.layer.borderColor = UIColor(red: 218, green: 218, blue: 218).cgColor
...
extension ForgotPassViewC: UITextFieldDelegate {
